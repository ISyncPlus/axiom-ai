...
const Footer = () => {
    ...
    return (
        ...
        >
            <span className="text-2xl font-semibold tracking-tight text-foreground">Axiom AI</span>
            ...
            <p className="text-muted-foreground">&copy; {new Date().getFullYear()} Axiom AI. All rights reserved.</p>
        </motion.div>
    )
}
