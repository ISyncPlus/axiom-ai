      ...
      <section className="flex flex-col lg:flex-row items-center justify-between w-full max-xl:gap-6 max-w-7xl lg:max-w-6xl">
        ...
        <section className="flex flex-col gap-8">
          <p className="text-md md:text-xl max-w-xl lg:max-w-md text-center lg:text-left">
            Automate repetitive work, organize knowledge, generate content, and
            collaborate seamlessly with AI-powered workflows designed for growing
            businesses.
          </p>
          <div className="flex flex-row gap-2">
            <Button className="rounded-full max-lg:hidden">Get started</Button>
