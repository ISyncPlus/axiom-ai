...
const features = [
    {
        title: "AI Assistants",
        description:
            "Delegate research, drafting, and answers to AI assistants that understand your business context.",
    },
    {
        title: "Workflow Automation",
        description:
            "Automate repetitive tasks and multi-step processes so your team can focus on real work.",
    },
    {
        title: "Knowledge Hub",
        description:
            "Keep every doc, decision, and answer in one searchable place your whole team can trust.",
    },
    {
        title: "Smart Documents",
        description:
            "Draft, edit, and generate content with AI built right into every document.",
    },
];
